...
window.Stubs.storeData1 = function () {
    ...
    //appIdPool
    store.set('appIdPool', ['app1','app2','app3','app4','app5','app6']);

    //workspaceIdPool
    store.set('workspaceIdPool', ['workspace1','workspace2','workspace3','workspace4']);

    //appInstIdPool
    store.set('workspaceIdPool', ['appInst1']);
